...
package carvajal.autenticador.android.framework.morphosmart.info;
...
import carvajal.autenticador.android.framework.morphosmart.subtype.SensorWindowPosition;
...
public class ProcessInfo {
	...
	private int callbackCmd = CallbackMask.MORPHO_CALLBACK_IMAGE_CMD.getValue() | CallbackMask.MORPHO_CALLBACK_ENROLLMENT_CMD.getValue()
			| CallbackMask.MORPHO_CALLBACK_COMMAND_CMD.getValue() | CallbackMask.MORPHO_CALLBACK_CODEQUALITY.getValue() | CallbackMask.MORPHO_CALLBACK_DETECTQUALITY.getValue();
	...
	private AutenticacionInfoActivity morphoSample = null;
	...
	public AutenticacionInfoActivity getMorphoSample() {
		return morphoSample;
	}

	public void setMorphoSample(AutenticacionInfoActivity morphoSample) {
