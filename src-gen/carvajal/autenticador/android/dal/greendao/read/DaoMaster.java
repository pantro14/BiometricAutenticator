...
import carvajal.autenticador.android.dal.greendao.write.DaoMaster.OpenHelper;
...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        CensoDao.createTable(db, ifNotExists);
        TemplatesDao.createTable(db, ifNotExists);
        ConfiguracionDao.createTable(db, ifNotExists);
        ProvinciasDao.createTable(db, ifNotExists);
        MunicipiosDao.createTable(db, ifNotExists);
        ColegiosElectoralesDao.createTable(db, ifNotExists);
        MesasDao.createTable(db, ifNotExists);
        ParametrosDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        CensoDao.dropTable(db, ifExists);
        TemplatesDao.dropTable(db, ifExists);
        ConfiguracionDao.dropTable(db, ifExists);
        ProvinciasDao.dropTable(db, ifExists);
        MunicipiosDao.dropTable(db, ifExists);
        ColegiosElectoralesDao.dropTable(db, ifExists);
        MesasDao.dropTable(db, ifExists);
        ParametrosDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(CensoDao.class);
        registerDaoClass(TemplatesDao.class);
        registerDaoClass(ConfiguracionDao.class);
        registerDaoClass(ProvinciasDao.class);
        registerDaoClass(MunicipiosDao.class);
        registerDaoClass(ColegiosElectoralesDao.class);
        registerDaoClass(MesasDao.class);
        registerDaoClass(ParametrosDao.class);
    }
